...
public class NeedRequirementController {
    ...
    @GetMapping(value = "/{needReqId}", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    public ResponseEntity<Page<SkillDetails>> getSkillDetailsByNeedType(
        ...
        Page<SkillDetails> skillDetails = needRequirementService.getSkillDetailsByNeedType(needTypeId, pageable);
